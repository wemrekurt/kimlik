...
$link = mysql_connect("localhost", "root", "5443323") or die(mysql_error());
$db = mysql_select_db("kimlik", $link) or die (mysql_error());
...
<?php 
$dir = opendir($sinif); 
$sqlsorgu=mysql_query("SELECT * FROM yemek WHERE sinif='$sinifadi'");
